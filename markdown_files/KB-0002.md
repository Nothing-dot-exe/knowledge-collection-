...
School of Electronic and Electrical Engineering, University of Sheffield, Sheffield S10 2TN, UK
...
3. Attribution experiments (§10): a preregistered same-day/cross-day variance decomposition of judge replay stability with dependence-aware uncertainty, a four-provider characterisation showing the floor at comparable magnitude on every tested platform, and a direct measurement of whether the system\_fingerprint fi eld predicts stability (it does not, in three distinct failure modes).
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Judge biases: position, verbosity, self-preference (Zheng et al., 2023; Wang et al., 2024; Panickssery et al., 2024) Judges' self-agreement across repeated calls, reported descriptively alongside human agreement or fidelity (Haldar & Hockenmaier, 2025; Norman et al., 2026; Choi et al., 2026) Temperature-zero drift traced to batch-dependent kernels; batch-invariant inference as remedy (Thinking Machines Lab, 2025; vLLM project, 2026) Behavioural drift across dated snapshots months apart (Chen et al., 2024) | a bias diagnostic inside the readout ( b map ), measured against the signal it contaminates, and the symmetrisation that cancels its first order (§5.1) the same quantity as an enforced preregistered gate (frozen threshold, no-repair rule, authority to terminate), byte-auditable, and decomposed into bias, separation, and platform terms (§4-§5) what the documented mechanism does to a preregistered evaluation : the permutation-readout amplifier, and same-day/cross-day plus four-provider floors under frozen bands (§6, §10) drift under byte-identical requests within one dated snapshot name , with every recorded metadata field constant (§5.3, §8) |
| Reporting checklists and preregistration proposals (Pineau et al., 2021; Kapoor et al., 2024; van Miltenburg et al., 2021; Biderman et al., 2024)                                                                                                                                                                                                                                                                                                                                                                              | the instrument-status items they lack (noise floor, gap distribution, fingerprint status, snapshot-identity level), each traced to a measured failure here (§9,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Judges and benchmarks framed as measurement instruments (Jacobs & Wallach, 2021; Freiesleben & Zezulka, 2025; Choi et al., 2026)                                                                                                                                                                                                                                                                                                                                                                                               | App. D) an executed instrument-validation campaign under that framing: gates, calibration, detection limits, audit boundary, and the full negative result disclosed (§3-§8, §12)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
|--------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
| Legacy D1    | Single-mapping exact two-label logprob: the observer must emit exactly A or B ; both exact labels are read at the single answer-token position                                        | r = e ℓ + / ( e ℓ + + e ℓ - )                                                                 |
| D1-S (v2.3a) | Dual-mapping adjacent pairs: each measurement point is asked twice, with the label-to-meaning mapping reversed between arms; probabilities are clipped at ε = 10 - 4 before the logit | z sym = ( z (+) + z ( - ) ) / 2, with mapping-bias diagnostic b map = ( z (+) - z ( - ) ) / 2 |
...
Gate I-3S (instrument stability, I0-S). Five subcriteria, all frozen: single-arm exact two-label coverage ≥ 0.995; pair completeness ≥ 0.990; arm label mass median ≥ 0.95 with 1st percentile ≥ 0.80; repeated-pair scalar stability, median | ∆ r sym | ≤ 0 . 03; and repeated candidate-ranking stability, within-task Spearman median ≥ 0.90 over the 10% repeated subset.

Gate I-5R (next-day replay, I0-R). After a mandatory ≥ 24 h gate, 100 preregistered judge requests are replayed with byte-identical request bodies against the same model name; the frozen criterion is full-ranking agreement (exact permutation match; recorded as "structured-field agreement" in the frozen artifacts) ≥ 0.99, with every preregistered canary kept in the denominator.

Missing labels invalidate the affected arm and pair; no tail-mass allocation, no imputation, and no posthoc metric substitution are permitted anywhere in the battery [phase1-i0s-fresh@ac06bb97] . One preregistration deviation in the second campaign is disclosed and bounded in §11.5: the calibration-stage freeze postdates two development results, so this paper never describes I0-R as fully pre-frozen.
...
| system_fingerprint                       | -                                                                                    | identical 100 / 100 (both windows: null )                    |
...
Phenomenon. The legacy single-mapping protocol passed its scalar repeatability criterion and failed its ranking criterion with a negative median : across inverted-mapping repeats, the within-task candidate-ranking Spearman median was -0.632 (frozen threshold ≥ 0.90), while the median absolute probability change was 0.0233, inside its ≤ 0.03 bound [phase1-oldD1@2dc38b05] . A negative median is the signature of something stronger than noise: flipping which label means "correct" tended to invert the ranking .
...
Mechanism. Define, over an adjacent mapping pair, the symmetrised logit z sym = ( z (+) + z ( - ) ) / 2 and the mapping-bias diagnostic b map = ( z (+) - z ( - ) ) / 2. If the readout carried only a correctness signal, b map would be zero up to noise. On the 136 legacy inverted pairs it is not: median 0.250 logits, quartiles - 0.187 to 0.875, 95th percentile of | b map | at 1.391 logits: the magnitude of the bias component rivals the dynamic range of the signal . Worse, it is not a constant offset that ranking could ignore: its median is +0.531 on correct candidates and -0.250 on incorrect ones, i.e. the bias interacts with the quantity being measured. Consistently, rankings computed from forward arms agree with rankings computed from reverse arms at a Spearman median of only 0.211 [docs-snapshot@33dda04b] . A single-mapping readout therefore confounds label-direction preference with correctness; whichever mapping a protocol happens to fix becomes part of its measurand. The successor protocol (D1-S) cancels the first-order antisymmetric component by construction, with the caveat, carried through §11, that symmetrisation does not guarantee the vanishing of higher-order interactions between label tokens and prompt content. The bias itself persists undiminished in the fresh window: over the 1,496 I0-S pairs, b map has median 0.3125, quartiles -0.1875 to 0.7500, and 95th percentile of | b map | at 1.3125 logits (Figure 6; recomputed from the pair data at figure-build time, [phase1-i0s-fresh@bbed8c1b] ). What symmetrisation changed is that the bias no longer , not

enters the readout that the observer stopped having it.

## 5.2 M2: repeat-ranking instability on a near-degenerate measurand (I0-S)

This is the paper's central mechanism. The symmetrised instrument produced what looks like a paradox: scalar repeatability of median | ∆ r sym | = 0 . 00671 (4.5 times better than its frozen bound) and a repeat-ranking Spearman median of 0.400 against a 0.90 gate, with 29 of 31 valid groups below threshold. The denominator is stated exactly: of the 32 repeated rank groups, one is constant on repeat and has no defined Spearman; the frozen validity rule excludes it, never imputes it, and ties within valid groups receive average ranks [docs-snapshot@e975a840] . The resolution is in two distributions measured by the frozen failure audit [docs-snapshot@57f3389b] :

What the instrument moves. Repeat deltas: quartiles 0.001-0.018, 90th/95th percentiles 0.052/0.080, maximum 0.167. Call this the instrument's noise floor: roughly 10 - 3 -10 - 2 in probability.

What there is to measure. Within a task, the four candidates' readouts span a median range of 0.0114; and the median minimum gap between adjacent candidates is 3 . 04 × 10 - 10 , with the 75th percentile still at 0.0005. Twelve of 32 groups contain exact ties on the original readout, 7 of 32 on the repeat; only 62 of 128 candidates keep even their within-pair arm order across repeats.

A ranking gate asks the instrument to resolve gaps , and here the typical gap sits four to seven orders of magnitude below the noise floor. Under repeat, candidates separated by 10 - 10 reorder with probability essentially 1 2 each; "scalar stable, ranking collapsed" is not a contradiction but arithmetic. The progressstratified medians confirm that the instrument detects order exactly where order exists to detect: Spearman medians by visible-prefix level are 0.000 (25% visible), 0.769 (50%), 0.500 (75%), 0.000 (100%). At one quarter of the trace, candidates have not yet diverged; at completion, the final answer is visible to the observer, readouts saturate, and same-correctness candidates become indistinguishable again; the ranking information lives mid-trace.
...
The three numbers are not three experiments; they are one experiment under three aggregations, and their spread is structural. Full-ranking agreement decays combinatorially in the candidate count: a single adjacent transposition anywhere in a 10-alias ranking voids the entire record. The q 45 scaling (45 candidate pairs at per-pair stability q , against q for pairwise agreement) is an illustrative independence bound, not an estimate : pair disturbances in a transitive ranking are neither independent nor identically distributed, so the exponent overstates the decay rate; the qualitative point, that record-level agreement is the fastest-decaying aggregation of the three, does not depend on independence. The observed spectrum (0.780 / 0.950 / 0.986, with a Kendall-distance spectrum concentrated at distance 1; §5.3) is what near-degenerate subsets under a small noise floor produce: overwhelming pairwise stability, frequent record-level violations.
...
The most natural response to an unstable readout is to average it. The original design anticipated this: its D2 protocol replaces the single-shot probability readout with M independent binary samples per measurement point, estimated with Jeffreys smoothing ˆ r = ( m + 1 2 ) / ( M + 1). This section shows why that route was closed: not by cost, but by arithmetic.

## 7.1 Setup

The frozen failure audit ran a deterministic simulation (500 replicates, seed 20260730) of the legacy D2 estimator over the I0-S repeat-task groups, using the frozen D1-S readouts as probability proxies (declared as proxies, not ground truth) and applying the frozen ranking gate (within-task Spearman median ≥ 0.90) to each simulated repeat [docs-snapshot@57f3389b] . Sampling noise falls as M - 1 / 2 ; if instability were a noise problem, some M would pass the gate.

## 7.2 Result

|   M |   Observer calls |   SE at p = 0 . 5 |   Gate median |   Gate q95 | Pass rate   |
|-----|------------------|-------------------|---------------|------------|-------------|
...
| Present but churning : many values inside one window | openai : 19 distinct values across one day's battery; 8 distinct values within a single 37-call window of the aborted r2 run | same-fingerprint pairs agree no better than different-fingerprint pairs (0.854 vs 0.884): the field does not predict stability |
...
| L1      | provider-pinned snapshot/deployment ID                                                                         | weights fixed; observable behaviour still not byte-stable                                                                | vendor documentation itself: model weights are fixed for a given ID while serving infrastructure changes around them, producing "minor differences in observable behavior" (Anthropic, 2026); empirically, the deepseek row above is an L1-like case failing a replay gate |
| L2      | self-hosted weights hash + batch-invariant deterministic kernels + pinned hardware class and framework version | replay stability far above the shared-endpoint floor while the server is quiet ; exactness must be verified, not assumed | directly measured on one stack only (the cross-track arm below: one model, one load pattern, driver version unrecorded); the general row is a recommendation grounded in (Thinking Machines Lab, 2025; vLLM project, 2026)                                                 |
...
The legacy campaigns left three attributions open: whether the replay disagreement of §5.3 was a cross-day effect or an instantaneous one; whether it was a property of one endpoint or of the platform class; and whether the readout can resolve true differences of known size at all, a question the legacy data could pose only in the instrument's own units (§5.2). All three were answered with new, preregistered, separately archived supplements, never pooled with the historical data, which enters below only as a qualitative reference line. The main-text claims were frozen before any supplement ran, and none moved a threshold: the supplements sharpen attribution and scope, the role prospective replication should play in a measurement paper.

## 10.1 A-S1: same-day/cross-day variance decomposition

Design (preregistration frozen at commit ffbeb95 before execution; descriptive, no pass/fail gate). The 100 frozen judge request bodies of the F2 window (§5.3) were replayed as a fixed probe battery: five windows per day with a ≥ 2 h spacing rule, on two days, 10 × 100 = 1 , 000 calls against the same endpoint and dated model snapshot as the historical window. Interpretation bands were frozen in advance: same-day/cross-day median difference | d | &lt; 0 . 03 reads as a nondeterminism floor, d ≥ 0 . 10 as a systematic cross-day component.
...
| Quantity                                                                                                                                                                                | Value                                                                  |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|
| median full-agreement, 20 same-day window pairs median full-agreement, 25 cross-day window pairs difference d top-1 agreement medians (same-day / cross-day) pairwise agreement medians | 0.805 0.800 0.005 → nondeterminism floor 0.950 / 0.960 0.9859 / 0.9860 |
...
| Provider   |   valid rate |   median same-day agreement |   d (same - cross) | decomposition        |
|------------|--------------|-----------------------------|--------------------|----------------------|
...
All four providers entered the platform-class test (valid rate ≥ 0.95 precondition), and its frozen reading fired: max = 0 . 879 &lt; 0 . 95 → platform-class property , a verdict name whose scope is exactly what was measured: these four providers, this 100-probe structured-ranking battery, these observation windows - valuable evidence about shared serving infrastructure, not a census of it. The window-level bootstrap and exact relabeling of §10.1, applied per provider, give d intervals within ± 0.03 for every provider (in-band fractions 0.91-0.95; all 252-split relabeling probabilities 1.0; no relabeling exceeds | d | = 0 . 03) [repo:docs/reports/dependence\_reanalysis.json] . No provider approaches replay-exactness; every provider's crossday behaviour equals its same-day behaviour; the ordering readout's stability differs by provider (0.74-0.88)

but its character does not. The fingerprint field completes the picture in three failure forms, absent / churning / stable-but-insufficient, measured in §8.1.
...
|----------------------|--------------------------------------------------------------------|-----------|------------|-----------------------------------------------------------|
| phase1-oldD1.zip     | 859ba16e971c3ca2f87e7db c75106d00340852801acc7c df1a6d97714c68ae56 |        83 |  2,989,738 | failure mode M1; legacy ledgers; excluded windows         |
| phase1-i0s-fresh.zip | e41bb822aebb310e38f2618 df20b0b942d160342036578 5e69100f01bc9c8e44 |        41 |  2,215,094 | failure mode M2; I-3S primary evidence; D2 simulation     |
| i0r-round.zip        | d0cff5cdcd4d3005338f34d 9a077f8a2e552311a2f6367 62c922460f4b65040d |       458 | 66,243,938 | failure mode M3; I-5R primary evidence; metric spectrum   |
| docs-snapshot.zip    | 87179236958ec882f091a57 db1ceafcfd07b44d202889e 3f485c67549114e24c |       204 |  1,112,797 | preregistration texts, gate definitions, closeout reports |

Prospective supplements (this study's new windows, sealed 2026-08-05/-26):

| Package            | SHA-256                                                            |   Members | Role                                                        |
|--------------------|--------------------------------------------------------------------|-----------|-------------------------------------------------------------|
| a-s1-r1.zip        | 196ab2e72cd10c72324ed269163 feb39dd95a5ca2c9da11e644b01 e1e7670d3a |        39 | A-S1 primary evidence (§10.1)                               |
| a-s1-v1-failed.zip | 4caac1c8e270b82ab47dd92a17e 513d17609a5ec2e8634332781a5 6f27a93def |        19 | A-S1 v1 failed instrument window (disclosure only)          |
| a-s2-probes.zip    | ebde3c776727e774444528ed189 6c021347066c1a40d371bab8ca4 3ee6d81d88 |        50 | capability & throughput probes (instrument calibration)     |
| a-s2-abandoned.zip | f5f4a64f3e8d0531a8daf528bd3 a942869003dc0d34bbd92fa1561 9195e64115 |        35 | A-S2 v1 (never run) and r2 aborted window (disclosure only) |
| a-s2-r3.zip        | 07ae32a50776a1e19b5bf7ed1ce ebc334bf94d4c5981eab78c5e17 037445e365 |        30 | A-S2 primary evidence (§10.2)                               |
| a-s3.zip           | a333e15fe5e3b5712f40a964860 f4bad155d58d498fce3de09580e 82e91d647f |         7 | A-S3 controlled-error battery, primary evidence (§10.3)     |
| a-s1-r2.zip        | 682b9b73e138c1268b68f233651 fcba10c43109bc3df81d64a51e5 74d6c5348a |        70 | A-S1 r2 five-day replication, primary evidence (§10.1)      |
| a-s1-r2-voided.zip | 35a5450d33f74a1511dbc0c67c1 040372fff0d6d149addd7f24cd7 74028b80ac |        13 | A-S1 r2 voided day-4 first attempt (disclosure only)        |
...
| Restricted | raw/api_events.jsonl (verbatim provider responses) for every run; one operator-side launcher script that embeds a local account path (frozen bytes are never edited, so it ships hash-only whole)                                                                                 |
...
Statistic. Median within-task rank Spearman between repeat readouts under the single-mapping protocol (B.1). Threshold. ≥ 0.90, frozen before execution. Denominator. All repeated task groups with defined Spearman; missing labels invalidate the affected arm. Outcome. -0.632456 at near-ceiling delivery (1,814/1,816; coverage 99.853%) [phase1-oldD1@2dc38b05] ; diagnosed in §5.1.
...
Figure 6: The mapping-bias diagnostic b map (half the difference of the two arms' logits; zero for an unbiased readout) in the legacy and fresh I0-S windows, faceted, never pooled. Right: the bias interacts with candidate correctness (legacy window; exploratory stratified view, no interaction test claimed).

<!-- image -->

|   # | Subcriterion                                          | Frozen threshold   | Measured            | Verdict   |
|-----|-------------------------------------------------------|--------------------|---------------------|-----------|
|   1 | Single-arm exact two-label coverage                   | ≥ 0.995            | 1.000               | pass      |
|   2 | Pair completeness                                     | ≥ 0.990            | 1.000               | pass      |
|   3 | Arm label mass, median and 1st percentile             | ≥ 0.95 / ≥ 0.80    | 0.999475 / 0.997172 | pass      |
|   4 | Repeat scalar stability, median &#124; ∆ r sym &#124; | ≤ 0.03             | 0.006710            | pass      |
|   5 | Repeat ranking stability, within-task Spearman median | ≥ 0.90             | 0.400               | fail      |
...
Design. After a mandatory ≥ 24 h gate, the 100 preregistered judge requests are replayed with byte-identical bodies (SHA-256 verified 100/100) against the same model name. Statistic. Full-ranking agreement (exact permutation match; "structured-field agreement" in the frozen artifacts). Threshold. ≥ 0.99. Denominator. All 100 replays, canaries kept. Outcome. 78/100 = 0.78 → fail [i0r-round@e8420c2f] . Prospectively frozen inside a campaign not described as fully preregistered (§11.5).

## A.5 A-S1 frozen interpretation bands (descriptive; no pass/fail)

Statistic. d = median( A within ) - median( A between ), where A is full-ranking agreement between window pairs (20 same-day, 25 cross-day pairs from ten windows). Frozen bands. | d | &lt; 0 . 03 reads as a nondeterminism floor; d ≥ 0 . 10 as a systematic cross-day component; intermediate values are reported without a name. Outcome. 0.805 - 0.800 = 0.005 → nondeterminism floor (§10.1). Preregistration frozen at commit ffbeb95 ; run manifests 069fd364... (Day 1), 47a78e6a... (Day 2). Replication round (r2). Frozen at 29b5962 with two further reading rules: a replication reading (same bands, five days, separate unit, no pooling) and a per-day spread reading (per-day same-day medians; spread beyond the 0.03 band names the least stable day). Outcomes: d = 0 . 0050 → replicated; spread 0.0450 → a day stood out (day 2); five day-manifests 38a73362... / 6800952c... / ba032eaf... / 26c25814... / 35dbe1a2... (§10.1).

## A.6 A-S2 three frozen readings (descriptive; per provider, never merged)

Preregistration frozen at commit cdc012f ; run manifests dabb7183... / 2a37b642... . (i) Platformclass test : given valid-readout rate ≥ 0.95 on every provider, read max p median( A p within ) against 0.95; outcome 0.8788 → fi red. (ii) Per-provider decomposition : A-S1's bands per provider; four floors (d = 0.000/0.000/0.000/-0.005). (iii) Fingerprint predictiveness at probe-level pairing; outcomes in §8.1.

## A.7 A-S3 reading rules (controlled-error battery)

Preregistration frozen at commit c145f0c ; plan 487e4e30... , battery 8f41e2fd... , manifest 2dd41dd5... . (i) Per-bin resolution: a bin is resolved when the 95% Wilson lower bound of its separation exceeds chance 0.5. (ii) Main verdict, one of four frozen outcomes over the four ε bins at or above 10 - 3 ; realised outcome: limit\_below\_smallest\_bin\_tested . (iii) The within-type contrast governs interpretation over the pooled table (frozen §14.3). (iv) The four-pass replay disagreement and the below-10 - 3 group are reported but enter no verdict. Outcomes in §10.3.
...
| I-3S fail (0.400 vs 0.90) I-5R fail (0.78 vs 0.99) A-S1 nondeterminism floor (d = 0.005) A-S2 platform-class + | sealed gate doc ac06bb97... frozen replay plan (§3.4) prereg @ ffbeb95 | run manifest 207cd6eb... run manifest 22c05608... manifests 069fd364... , 47a78e6a... | §4.1, §5.2 §4.1, §5.3 §10.1 |
| fingerprint readings                                                                                           | prereg @ cdc012f                                                       | manifests dabb7183... , 2a37b642...                                                   | §10.2, §8.1                 |
| A-S3 limit not bracketed; type-governed separation                                                             | prereg @                                                               | manifest 2dd41dd5...                                                                  |                             |
| L2 arm: quiet 0.9872 / loaded 0.8925 (clean subset); batch invariance necessary, not sufficient                | c145f0c                                                                |                                                                                       | §10.3                       |
|                                                                                                                | cross-line prereg @ 33a5f25... (white-box track)                       | run manifest 5d34c129... ; report hash in the citation ledger                         | §8.3                        |
...
| Item               | Value                                                                                                                                                                                                       |
|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Task seed / design | 20260729 ; 80 tasks × 4 candidates = 320; visible steps 4-8; prefix grid J = 4                                                                                                                              |
| Generator          | gpt-4o-mini-2024-07-18 (family openai-gpt-4o ), temperature 0.8, strict structured outputs                                                                                                                  |
| Observer           | qwen3.7-plus-2026-05-26 (family qwen3.7-plus ), shared OpenAI-compatible Chat Completions endpoint (DashScope compatible mode), temperature 0.0, max_completion_tokens 1, top_logprobs 5, thinking disabled |
| Measurement        | Protocol d1_symmetric ; mappings { A ↦→ + ,B ↦→-} and { B ↦→ + ,A ↦→-} ; clip ε = 10 - 4 ; repeat fraction 0.10; no imputation; no candidate reuse                                                          |
...
| Stage 3-F1 first freeze: missing local parser/alias-map metadata Legacy D1-S diagnostic (136 pairs)                                                                                                         | voided before live; re-frozen; both manifests retained exploratory only                                                                                   | first version never used for execution never grounds for declaring I-3S passed                                                                            |
| Rejected candidate-reuse route (2 dry runs) A-S1 v1 Day-1 window: 100 calls, 100 responses, 0 valid readouts (an SDK-shape parameter never entered the wire body, so thinking                               | fresh restart adopted (legacy provenance unrecoverable, §12.4) permanently excluded; r1 re-froze with the wire defect fixed                               | recorded as a rejected design disclosed as an instrument-failure exhibit; the archived request hash pins SDK-parameter shape, not                         |
| mode stayed enabled and every response hit the token limit) A-S2 r2 Day-1: aborted after 238 attempts (provider rate-limit quota                                                                            | run left unsealed; never enters any denominator; one in-flight plan ID permanently retired                                                                | wire bytes disclosed; redesign went through full re-freezing, not amendment                                                                               |
| exposed two frozen premises as false) A-S2 r3 first Day-1: aborted after 618 attempts (a scheduling guard parsed plan IDs by fixed position, never matched A-S2's shape, and silently allowed a 10.6-minute | run left unsealed; excluded; one in-flight plan ID permanently retired; the guard was rewritten to refuse what it cannot parse                            | disclosed; the frozen schedule itself was correct and unchanged                                                                                           |
| window gap against a frozen ≥ 2 h rule) A-S1 r2 first Day-4 (385 attempts): two executor processes wrote one run directory; window 2 received 285 requests, and 21                                          | run left unsealed; voided whole and archived separately ( a-s1-r2-voided.zip ); day 4 re-ran four days later under a new run group, after a runbook guard | permanently excluded; cost retained; the round's pre-signed seven-date authorisations (researcher travelling; one date expired unused) are disclosed with |
| concurrently probes carry conflicting readings                                                                                                                                                              | against concurrent executors                                                                                                                              | it                                                                                                                                                        |
...
| b map , z sym          | mapping-bias diagnostic; symmetrised readout                                       | §3.2, App. B  |
...
The legacy readout instructs the observer to answer with exactly one of two labels and reads both labels' log-probabilities at the single answer-token position: r = e ℓ + / ( e ℓ + + e ℓ - ), exact (no sampling); a missing label invalidates the arm. Its gate outcome (A.1) showed the readout confounds label-direction preference with the correctness signal (§5.1), motivating the symmetrised successor: each measurement point is asked twice with the label-to-meaning mapping reversed, each arm's probability is clipped at ε = 10 - 4 and taken through the logit z = logit(clip( r, ε )), giving

<!-- formula-not-decoded -->

An unbiased readout has b map = 0 up to noise; its measured distribution is the M1 evidence (§5.1). Arm order was balanced by frozen seed (748 forward-first, 748 reverse-first); a missing label invalidates arm and pair, with no imputation. The frozen 10% repeat subset grounds Gate I-3S subcriteria 4-5 (A.3).

## B.2 Structured full-ranking judge (I0-R) and the A-S3 judgment

The judge returns one JSON object whose ranking fi eld must be an exact permutation of the ten presented aliases; parsing is all-or-nothing, and an invalid readout is retained as a failure, never retried into validity. The readout is the permutation; derived statistics are full-ranking agreement (the frozen decision metric), top-1 agreement, and pairwise agreement (1 minus normalised Kendall distance) (§6). The protocol was selected on frozen development data before the confirmatory stages (§11.5). A-S3 reuses this wire contract on constructed candidates: one judgment is the event that the correct candidate strictly outranks a given slip candidate, and a bin's separation is the fraction of its judgments that hold, with a 95% Wilson interval against chance 0.5; bin membership is fixed by the constructed relative error, known before any call (§10.3).
...
| system_fingerprint        | copied verbatim, including null                             | 3                |
...
|   # | Report                                                                                                                                                                                                                                                                       | Trace       |
|-----|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
|   1 | D.1 Instrument identity Snapshot-identity level: L0 (model name) / L1 (pinned snapshot or dedicated deployment) / L2 (self-hosted; weights hash, framework, hardware class, determinism settings)                                                                            | §8.3        |
...
|   5 | D.2 Pre-freeze instrument measurement Noise floor of the readout: repeat-delta distribution from a frozen pilot battery, per aggregation level if §9.5 applies                                                                                                               | §5.2        |
...
|   7 | Fraction of the intended denominator below the declared resolution bound δ , and the preregistered exclusion rule                                                                                                                                                            | §9.3        |
|   8 | For platform-stability gates: the same-window agreement floor measured on this endpoint D.3 Gate design                                                                                                                                                                      | §10.1       |
...
|  13 | D.4 Measurement definition The unit of measurement: single call, or prospective aggregate ( k , aggregator, tie rule) fixed before execution                                                                                                                                 | §9.5        |
|  14 | Handling of invalid readouts: retained-as-failure vs excluded, fixed in advance; no imputation                                                                                                                                                                               | §4.2        |
|  15 | The prohibition list in force (no replay-selection, no post-hoc metric substitution, no threshold movement) D.5 Execution audit                                                                                                                                              | §4.2, §6.2  |
...
|  19 | Execution-integrity summary separated from scientific verdicts D.6 Disclosure and reproduction                                                                                                                                                                               | §4.3        |
|  20 | Excluded-data register: every excluded run with reason, disposition, standing obligation; costs retained                                                                                                                                                                     | §12.1, A.10 |
|  21 | Request-attempt ledger by scope, with the non-pooling declaration (audit volume = sample size)                                                                                                                                                                               | §12.2       |
